    ...
    while (true) {
        ...
        switch (input) {
            ...
            case 3: {
                ...
                cin >> idPramugari;
                deletePramugariByID(LP, idPramugari);
                cout << endl;
                break;
            }
            case 4: {
                ...
                cin >> idPramugari;
                searchPramugariByID(LP, idPramugari);
                cout << endl;
                break;
            }
            case 5: {
                ...
                editPramugariByID(LP, idPramugari);
                cout << endl;
                break;
            }
            case 6:
            ...
            case 7: {
                ...
                cin >> idPenumpang;
                searchPenumpangByID(LP, idPenumpang);
                cout << endl;
                break;
            }
            case 8: {
                ...
                cin >> idPenumpang;
                cin.ignore(); // Mengabaikan newline
                editPenumpangByID(LP, idPenumpang);
                cout << endl;
                break;
            }
            case 9: {
                ...
                cin >> idPramugari;
                cin.ignore();
                connectPenumpangAndPramugari(LP, idPenumpang, idPramugari);
                cout << endl;
                break;
            }
            case 10:
            ...
            case 11:
                ...
                cout << "+-----------------------------+" << endl;
                displayPramugariWithMostPenumpang(LP);
                cout << endl;
                break;
            case 12: {
                cout << "+-----------------------------+" << endl;
                ...
                cin >> idPramugari;
                cin.ignore();
                findPenumpangInPramugari(LP, idPramugari);
                cout << endl;
                break;
            }
            case 13: {
                ...
                cin >> idPenumpang;
                cin.ignore();
                deletePenumpangFromPramugari(LP, idPramugari, idPenumpang);
                cout << endl;
                break;
            }
            default:
